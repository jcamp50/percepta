...
Logs can be filtered by category (audio, chat, stream_metadata, stream_event_sub, system)
...
class CategoryFilter(logging.Filter):
    ...
    def __init__(self, category: Optional[str] = None):
        ...
        Args:
            category: Category name for this logger (e.g., 'audio', 'chat', 'system')
        """
        super().__init__()
...
def get_logger(name: str, category: Optional[str] = None) -> logging.Logger:
    ...
    Args:
        ...
        category: Category for filtering (e.g., 'audio', 'chat', 'system')
